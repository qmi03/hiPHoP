<section class="mt-10 bg-white mx-5 lg:mx-20 p-10 relative text-lg">
  <div>
    Sent by <span class="font-bold"><?= $data['message']->username ?></span> on <span class="font-bold"><?= $data['message']->createdAt->format('Y-m-d H:i') ?></span>
  </div>
  <div>
  ...
  <?php if ($data['message']->respondedAt != null): ?>
    <div class="mt-5">
      Responded on <span class="font-bold"><?= $data['message']->respondedAt->format('Y-m-d H:i') ?></span>
    </div>
    <div>
  ...
  <?php else: ?>
    <div class="mt-5">
      <span class="text-gray-500 italic">Not responded yet...</span>
    </div>
  <?php endif; ?>
</section>
